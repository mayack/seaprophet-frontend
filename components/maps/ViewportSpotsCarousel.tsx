...
export function ViewportSpotsCarousel({
  ...
  return (
    ...
    >
      ...
      <div className="embla overflow-hidden px-4 pt-3 pb-2" ref={emblaRef}>
        <div className="embla__container flex gap-2 pb-2">
          {spots.map((spot) => (
            <div
              key={spot.id}
              className="embla__slide min-w-0 flex-[0_0_calc(50%-0.25rem)] min-[1366px]:!flex-[0_0_calc(20%-0.4rem)] min-[1680px]:!flex-[0_0_calc(16.666%-0.417rem)] min-[1920px]:!flex-[0_0_calc(14.285%-0.429rem)] sm:flex-[0_0_calc(33.333%-0.334rem)] lg:flex-[0_0_calc(25%-0.375rem)]"
            >
              <SpotSummaryCard
                spot={spot}
                variant="elevated"
